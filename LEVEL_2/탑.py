...
test_cases = [
    {"heights": [6, 9, 5, 7, 4], "expected_value": [0, 0, 2, 2, 4]},
    {"heights": [3, 9, 9, 3, 5, 7, 2], "expected_value": [0, 0, 0, 3, 3, 3, 6]},
    {"heights": [1, 5, 3, 6, 7, 6, 5], "expected_value": [0, 0, 2, 0, 0, 5, 6]},
]

for test_case in test_cases:
    heights, expected_value = test_case["heights"], test_case["expected_value"]

    print(solution(heights) == expected_value)
